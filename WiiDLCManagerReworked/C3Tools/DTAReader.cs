...
namespace WiiDLCManagerReworked.C3Tools
{
    class DTAReader
    {
                ...
                for (var i = 0; i < DTAEntries.Count; i++)
                {
                    ...
                    for (var z = 0; z < entry.Count; z++)
                    {
                        try
                        {
                            ...
                            {
                                song.OverrideName = GetConfigString(line);
                            }
    ...
    public class SongData
    {
        ...
        public short HopoThreshold { get; set; }
